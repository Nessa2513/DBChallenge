...
idEmployee INT NOT NULL,
employeeStudies VARCHAR(45) NOT NULL,
graduationYear VARCHAR(45) NOT NULL,
CONSTRAINT 	FKI_idEmployee  FOREIGN KEY (idEmployee)  
					REFERENCES Employee  (idEmployee)
                    ON DELETE CASCADE
					ON UPDATE CASCADE
);
...
INSERT INTO Institution (idInstitution, institutionName, idEmployee, employeeStudies, graduationYear) VALUES ('100', 'Universidad de Pamplona', '74', 'Lenguas extranjeras', '2020');
INSERT INTO Institution (idInstitution, institutionName, idEmployee, employeeStudies, graduationYear) VALUES ('101', 'Universidad Nacional de Colombia', '83', 'Filosofía', '2007');
INSERT INTO Institution (idInstitution, institutionName, idEmployee, employeeStudies, graduationYear) VALUES ('102', 'Universidad de la Sabana', '92', 'Ingeniería informática', '2015');
INSERT INTO Institution (idInstitution, institutionName, idEmployee, employeeStudies, graduationYear) VALUES ('103', 'Universidad El Bosque', '95', 'Diseño insdustrial', '2012');
INSERT INTO Institution (idInstitution, institutionName, idEmployee, employeeStudies, graduationYear) VALUES ('104', 'Universidad Pontificia Javeriana', '64', 'Artes', '2010');
